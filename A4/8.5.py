...
def plotOriginalPoints(masterPntCol):
	...
	fig = plt.figure()
	fig.suptitle('Recall-Precision graph at 5. No. of relevant docs for recall is 16', fontsize=14, fontweight='bold')
...
def calcPrecRecallAtK(query, K, data, returnType='single'):
	...
	#16 relevant documents/query in CACM: http://www.cs.sfu.ca/CourseCentral/456/jpei/web%20slides/L19%20-%20Evaluation.pdf
	foundFlag = False
...
#8.5 output file is: map-prec-at-10-avg-ndcg-r-prec.txt
lines = getInput()
MAP = 0
rPrecision = 0
...
for query in range(1, 65):
	...
	#mean average precision (MAP) calculated using ranking window of size 10
